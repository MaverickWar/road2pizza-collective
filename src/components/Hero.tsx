...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-screen w-full mt-[48px] md:mt-[40px]">
      <div 
      ...
      <div className="relative w-full px-4 sm:px-6 lg:px-8 py-12 md:py-16 lg:py-20 flex flex-col justify-center min-h-screen">
