...
export const AdminHeader = () => {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 md:left-64 z-50 bg-admin-gradient p-3 md:p-6 shadow-admin">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="flex flex-col gap-2 md:flex-row md:items-center">
          <h1 className="text-xl md:text-2xl font-bold text-white">Admin Dashboard</h1>
          <Link 
            to="/" 
            className="inline-flex items-center gap-2 px-3 py-1.5 bg-white/10 rounded-lg border border-white/20 backdrop-blur-sm hover:bg-white/20 transition-colors w-fit"
          >
